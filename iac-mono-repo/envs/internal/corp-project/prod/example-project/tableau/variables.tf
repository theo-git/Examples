...
variable "tableau_domain_name" {
  default = "2018.analytics.multiscalehn.com"
}
...
#Tableau requires a minimum of 2 cores and 8GB of RAM.  
#Therefore 'n1-standard-4' is recommended as a minimum base for Dev servers.
